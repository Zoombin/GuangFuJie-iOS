...
class LeaseViewController: BaseViewController, ProviceCityViewDelegate {
    ...
    func initView() {
        ...
        imageView1.tag = 0
        imageView1.layer.borderColor = Colors.appBlue.cgColor
        ...
        imageView2.tag = 1
        imageView2.layer.borderColor = Colors.appBlue.cgColor
        ...
        imageView3.tag = 2
        imageView3.layer.borderColor = Colors.appBlue.cgColor
