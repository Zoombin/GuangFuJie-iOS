//
//  GJQuestionMyViewController.swift
//  GuangFuJie
//
...
class GJQuestionMyViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func loadQuestionList() {
        API.sharedInstance.qaList(start: currentPage, pagesize: 10, isMy: true, success: { (count, array) in
