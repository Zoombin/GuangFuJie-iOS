//
//  QestionAllViewController.swift
//  GuangFuJie
//
...
class QestionAllViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func loadQuestionList() {
        API.sharedInstance.qaList(start: currentPage, pagesize: 10, isMy: false, success: { (count, array) in
