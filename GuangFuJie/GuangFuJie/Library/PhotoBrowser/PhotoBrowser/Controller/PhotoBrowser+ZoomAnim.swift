...
extension PhotoBrowser{
    ...
    func zoomOutWithAnim(page: Int){
        ...
        UIView.animateWithDuration(0, delay: 0, usingSpringWithDamping: 0.6, initialSpringVelocity: 20, options: UIViewAnimationOptions.CurveEaseOut, animations: {[unowned self] () -> Void in
                self.view.alpha = 0
